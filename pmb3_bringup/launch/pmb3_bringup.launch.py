...
def generate_launch_description():
    ...
    default_controllers_launch = include_launch_py_description(
        'pmb3_controller_configuration', ['launch', 'default_controllers.launch.py'])

    twist_mux_launch = include_launch_py_description(
        'pmb3_bringup', ['launch', 'twist_mux.launch.py'])

    pmb3_state_publisher = include_launch_py_description(
        'pmb3_description', ['launch', 'robot_state_publisher.launch.py'])
    ...
    ld.add_action(pmb3_state_publisher)
