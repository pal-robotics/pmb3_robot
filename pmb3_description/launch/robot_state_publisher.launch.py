...
from launch_pal.robot_utils import (get_camera_model,
                                    get_laser_model,
                                    get_robot_name)
...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description = {'robot_description': load_xacro(
        Path(os.path.join(
            get_package_share_directory('pmb3_description'), 'robots', 'pmb3.urdf.xacro')),
        {
...
def generate_launch_description():
    ...
    ld.add_action(get_robot_name('pmb3'))
